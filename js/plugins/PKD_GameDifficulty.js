...
PKD_GameDifficulty.LoadPluginSettings = function() {
  ...
  if (PKDGD.PP.getDifficultyTable && PKDGD.PP.getDifficultyTable().length < 2) {
...
// Limitador de versión BÁSICA deshabilitado - permite 3 dificultades
// El código ofuscado original se ha reemplazado para permitir más dificultades
